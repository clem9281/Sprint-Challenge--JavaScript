...
console.log("tyranosaurus period: ", tyrannosaurus.period);
...
console.log("Request 1: Universities: ", universities);

const alphabeticalUnis = universities.sort((a, b) =>
  a.toUpperCase() < b.toUpperCase() ? -1 : 1
);
console.log("Request 1: Sorted Universities: ", alphabeticalUnis);
...
console.log("Request 2: Contact Info: ", contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = universities.filter(school => /uni/gi.test(school));
console.log("Request 3: Uni: ", uni);
...
console.log("Request 2: .map(): ", lowerCase);
...
console.log("Request 3: .filter(): ", largerPopulation);
